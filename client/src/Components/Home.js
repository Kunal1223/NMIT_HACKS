...
const Home = () => {
  return (
    <>
      <div className='home-container flex justify-between mt-20 items-center'>
        <div className='ml-32 '>
          ...
          <button className='bg-green-400 text-white p-2 hover:bg-green-700 rounded-xl mt-4' >Providing Meal<i className="fa-solid fa-plate-wheat ml-2
           "></i></button>
        </div>
        <VideoComponent />
      </div>
